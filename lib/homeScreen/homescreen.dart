...
import 'package:waterreminder/Doctors%20Appointment/doctorsAppointment.dart';
            ...
            Expanded(
              child: Padding(
                  ...
                  children: [
                    InkWell(
                      child: Card(
                        ...
                        onTap: () { Navigator.pushNamed(context, '/second2');}
                ...
                InkWell(
                    ...
                    onTap: () { Navigator.pushNamed(context, '/second1');}
                ),
                    InkWell(child:Card(
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(8),
                    ...
                    InkWell(child: Card(
                        ...
                        onTap: () { Navigator.of(context).push(MaterialPageRoute( builder: (context) => App()));}
                    ),
                    InkWell(child: Card(
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(8),
